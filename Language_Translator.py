###used in version IDLE(python 3.9 64-bit)
from tkinter import *
...
root=Tk()
root.title("project by Jeevagan--Language translator")
...
def translate_now():
    ...
    try:
        ...
        messagebox.showerror("googletrans","try something acceptable")
...
Label(root,text ="Project by Jeevagan", font = 'arial 20 bold', bg ='white smoke' , width = '20').pack(side = 'bottom')
